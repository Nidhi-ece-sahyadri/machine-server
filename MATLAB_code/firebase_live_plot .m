...
% Firebase & Settings
%% ==============================
uploadURL = 'https://machine-server-1rw7.onrender.com/live-csv';

firebaseURL = 'https://machine-health-monitorin-7e352-default-rtdb.firebaseio.com/machine_data.json';
...
webwrite(uploadURL, csvText, opts);
    ...
    fprintf("⚠️ Render Upload Error: %s\n", ME.message);
end
