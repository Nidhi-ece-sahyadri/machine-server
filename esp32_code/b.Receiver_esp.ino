...
const char* firebaseURL = "https://machine-health-monitorin-7e352-default-rtdb.firebaseio.com/machine_data.json";
...
void OnDataRecv(const esp_now_recv_info_t *info, const uint8_t *data, int len) 
{
  ...
  // -------- Remaining values: Voltage, RPM, Current --------
